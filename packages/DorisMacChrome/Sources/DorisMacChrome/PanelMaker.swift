...
public enum PanelMaker {
    ...
    public static func sidebar<Content: View>(
        ...
        panel.title = "Doris Sidebar"
        return panel
    }

    /// Create the always-visible Open Bar trigger.
    public static func openBar(edge: SidebarEdge, height: CGFloat) -> DorisOpenBarPanel {
        let panel = DorisOpenBarPanel(
...
public final class DorisSidebarPanel: NSPanel {
    public override var canBecomeKey: Bool { true }
    public override var canBecomeMain: Bool { false }
}

public final class DorisOpenBarPanel: NSPanel {
