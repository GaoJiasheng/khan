...
public enum KeychainSecretStore {
    ...
    /// When `KHAN_DISABLE_KEYCHAIN=1`, the secret store falls back to a per-user file in the
    ...
    private static var keychainDisabled: Bool {
        ProcessInfo.processInfo.environment["KHAN_DISABLE_KEYCHAIN"] == "1"
    }

    public static func keychainAccessGroup() -> String? {
        guard let prefix = teamIDPrefix() else { return nil }
        return "\(prefix)\(KhanIdentifiers.appGroup)"
    }
    ...
    public static func loadSecret() throws -> Data {
        ...
        var query: [String: Any] = [
            ...
            kSecAttrService as String: KhanIdentifiers.keychainService,
            kSecAttrAccount as String: KhanIdentifiers.keychainAccount,
    ...
    public static func ensureSecret() throws -> Data {
        ...
        let new = KhanHMAC.generateSecret()
        try saveSecret(new)
        return new
    }
    ...
    private static func teamIDPrefix() -> String? {
        ...
        let query: [String: Any] = [
            kSecClass as String: kSecClassGenericPassword,
            kSecAttrService as String: "khan-team-probe",
    ...
    private static func fileURL() throws -> URL {
        ...
        return dir.appendingPathComponent(".khan-hmac-secret")
    }
