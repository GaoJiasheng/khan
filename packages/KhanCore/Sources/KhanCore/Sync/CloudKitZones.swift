...
public enum CloudKitZones {
    ...
    public static var notesZoneID: CKRecordZone.ID {
        CKRecordZone.ID(zoneName: KhanZones.notes, ownerName: CKCurrentUserDefaultName)
    }

    public static var messagesZoneID: CKRecordZone.ID {
        CKRecordZone.ID(zoneName: KhanZones.messages, ownerName: CKCurrentUserDefaultName)
    }

    public static var outboxZoneID: CKRecordZone.ID {
        CKRecordZone.ID(zoneName: KhanZones.outbox, ownerName: CKCurrentUserDefaultName)
    }

    public static var devicesZoneID: CKRecordZone.ID {
        CKRecordZone.ID(zoneName: KhanZones.devices, ownerName: CKCurrentUserDefaultName)
    }
