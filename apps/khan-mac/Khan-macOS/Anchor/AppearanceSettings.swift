...
final class AppearanceSettings: ObservableObject {
    ...
    @Published var backgroundOpacity: Double {
        didSet {
            UserDefaults.standard.set(backgroundOpacity, forKey: "khan.appearance.backgroundOpacity")
        }
    }

    private init() {
        let raw = UserDefaults.standard.object(forKey: "khan.appearance.backgroundOpacity") as? Double
